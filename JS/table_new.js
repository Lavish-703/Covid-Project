...
function setData(DATA, updatedDate){
    ...
    for(var i=0; i < DATA.centers.length; i++){
        ...
        if(vaccine_type==sortVaccine){
            ...
            //     var format = '<div class="card container"><div class="card__content"><p><div class="vaccine_name">'+vaccine_type+'</div><strong><span class="heading">'+name+'</span></strong><br>'+address+'<br>North Delhi<br>'+age+'<br>'+fee+'<br>Dose 1 - '+dose_1+'<br>Dose 2 - '+dose_2+'<br></p></div></div>'
            ...
            // }else{
            //     var format = '<div class="card container"><div class="card__content"><p><div class="vaccine_name">'+vaccine_type+'</div><strong><span class="heading">'+name+'</span></strong><br>'+address+'<br>North Delhi<br>'+age+'<br>'+fee_type+'<br>Dose 1 - '+dose_1+'<br>Dose 2 - '+dose_2+'<br></p></div></div>'
            //     document.getElementById("vaccine_info").innerHTML+= format;
